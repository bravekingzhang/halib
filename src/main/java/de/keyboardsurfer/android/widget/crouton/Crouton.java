 ...
 * <p/>
 * <b>Important: </b>
 * Call {@link de.keyboardsurfer.android.widget.crouton.Crouton#clearCroutonsForActivity(android.app.Activity)} within
...
public final class Crouton {
  ...
  /**
   * Creates the {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   *
   * @param activity
   *     The {@link android.app.Activity} that the {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be attached
   *     to.
   * @param text
   *     The text you want to display.
   * @param style
   *     The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
   */
   ...
   *     The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
   * @param viewGroup
   *     The {@link android.view.ViewGroup} that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be added to.
   */
   ...
   *     The {@link android.view.ViewGroup} that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be added to.
   * @param configuration
   *     The {@link Configuration} for this {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   */
  ...
  /**
   * Creates a {@link de.keyboardsurfer.android.widget.crouton.Crouton} with provided text and style for a given
   * activity.
   *
   * @param activity
   *     The {@link android.app.Activity} that the {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be attached
   ...
   *     The style that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be created with.
   *
   * @return The created {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   */
   ...
   *     The resource id of the {@link android.view.ViewGroup} that this {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be added to.
   *
   * @return The created {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   */
  ...
  /**
   * Creates a {@link de.keyboardsurfer.android.widget.crouton.Crouton} with provided text-resource and style for a given
   * activity.
   *
   * @param activity
   *     The {@link android.app.Activity} that the {@link de.keyboardsurfer.android.widget.crouton.Crouton} should be attached
  ...
  /**
   * Creates a {@link de.keyboardsurfer.android.widget.crouton.Crouton} with provided text and style for a given activity
   * and displays it directly.
   *
   * @param activity
   *     The {@link android.app.Activity} that the {@link de.keyboardsurfer.android.widget.crouton.Crouton} should
   *     be attached to.
   * @param text
   *     The text you want to display.
   * @param style
  ...
  /**
   * Allows hiding of a previously displayed {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   *
   * @param crouton
   *     The {@link de.keyboardsurfer.android.widget.crouton.Crouton} you want to hide.
   */
  ...
  /**
   * Cancels all queued {@link de.keyboardsurfer.android.widget.crouton.Crouton}s. If there is a {@link de.keyboardsurfer.android.widget.crouton.Crouton}
  ...
  /**
   * Cancels a {@link de.keyboardsurfer.android.widget.crouton.Crouton} immediately.
   */
  public void cancel() {
  ...
  /**
   * Displays the {@link de.keyboardsurfer.android.widget.crouton.Crouton}. If there's another {@link de.keyboardsurfer.android.widget.crouton.Crouton} visible at
   * the time, this {@link de.keyboardsurfer.android.widget.crouton.Crouton} will be displayed afterwards.
   */
  public void show() {
  ...
  /**
   * Removes this {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   *
   * @since 1.9
   */
  public void hide() {
  ...
  /**
   * Allows setting of an {@link android.view.View.OnClickListener} directly to a {@link de.keyboardsurfer.android.widget.crouton.Crouton} without having to use a custom view.
   *
   * @param onClickListener
   *     The {@link android.view.View.OnClickListener} to set.
   *
   * @return this {@link de.keyboardsurfer.android.widget.crouton.Crouton}.
   */
  ...
  /**
   * Set the {@link Configuration} on this {@link de.keyboardsurfer.android.widget.crouton.Crouton}, prior to showing it.
   *
   * @param configuration
  ...
  /**
   * @return <code>true</code> if the {@link de.keyboardsurfer.android.widget.crouton.Crouton} is being displayed, else
   * <code>false</code>.
   */
  boolean isShowing() {
  ...
  /**
   * Removes the activity reference this {@link de.keyboardsurfer.android.widget.crouton.Crouton} is holding
   */
  void detachActivity() {
    activity = null;
  }
  ...
  /**
   * Removes the viewGroup reference this {@link de.keyboardsurfer.android.widget.crouton.Crouton} is holding
   */
  ...
  /**
   * Removes the lifecycleCallback reference this {@link de.keyboardsurfer.android.widget.crouton.Crouton} is holding
   */
