 ...
 * <p/>
 * <p>
 * {@link in.srain.cube.image.iface.ImageLoadHandler#onLoading(ImageTask, CubeImageView)} will be called when begin to load the image.
 * </p>
 * <p/>
 * <p>
 * {@link in.srain.cube.image.iface.ImageLoadHandler#onLoadFinish(ImageTask, CubeImageView, android.graphics.drawable.BitmapDrawable)} will be called after the image is loaded.
 * </p>
 */
