...
/**
 * Implement {@link ICubeFragment}, {@link in.srain.cube.app.lifecycle.IComponentContainer}
 * <p/>
 * Ignore {@link in.srain.cube.app.lifecycle.LifeCycleComponentManager#onBecomesPartiallyInvisible}
 */
public abstract class CubeFragment extends Fragment implements ICubeFragment, IComponentContainer {
    ...
    /**
     * ===========================================================
     * Implements {@link in.srain.cube.app.lifecycle.IComponentContainer}
     * ===========================================================
     */
    @Override
